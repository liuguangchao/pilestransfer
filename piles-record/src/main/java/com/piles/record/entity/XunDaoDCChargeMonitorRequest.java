...
//        request.setTemp(BytesUtil.copyBytes(msg, cursor, 4));
    ...
    public static byte[] packBytes(XunDaoDCChargeMonitorRequest request) {
    ...
    public static void main(String[] args) {
        ...
        //依照报文体规则解析报文
        XunDaoDCChargeMonitorRequest uploadChargeMonitorRequest = XunDaoDCChargeMonitorRequest.packEntity(dataBytes);
    }
}
